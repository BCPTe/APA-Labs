...
Version     : 1.0
Copyright   : ++NONE++
Description : Laib_4 Exercise 5 - APA 19/20 PoliTO
=============================================================
*/
...
int fill_log(FILE *log, info_log total_log[MAXENTRIES], info_log *ptr_sorted[][MAXENTRIES]);
comando_e leggiComando(comando_e *lastcmd);
void selezionaDati(comando_e pick, comando_e lastcmd, info_log *ptr_sorted[][MAXENTRIES], int total_entries);
void order(info_log *ptr_sorted[MAXENTRIES], int total_entries, int ord_type);
void search(info_log *ptr_sorted[MAXENTRIES], int total_entries);
void printfunct(info_log *ptr_sorted[MAXENTRIES], int total_entries);
...
int main(){
    ...
    FILE *log;
    info_log total_log[MAXENTRIES], *ptr_sorted[r_capolinea][MAXENTRIES];
